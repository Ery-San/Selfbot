...
cl = PUY.LINE()
cl.login(token="EnzCg3iIzjqZc2DCACT9.EfpJFP2BI4IPcQpMVXsXwq.+yJ5vFLa84H5mvC3fihOCKzcYAyh0tlFhuBrhSf6P2I=")
cl.loginResult()
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u7853e37e9d9b8b88a90aa3e6bf14b159',"}
                cl.sendMessage(msg)
